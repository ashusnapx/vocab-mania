        ...
        <div className={`mx-auto max-w-3xl rounded-[32px] bg-primary-container p-10 text-center shadow-lg md:p-16 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <div className="animate-pulse-glow rounded-full">
              <PillButton label={WHY_BEST.cta.primaryCta.label} href={WHY_BEST.cta.primaryCta.href} variant="filled" size="lg" />
            </div>
            <PillButton label={WHY_BEST.cta.secondaryCta.label} href={WHY_BEST.cta.secondaryCta.href} variant="outlined" size="lg" />
          </div>
          <p className="mt-4 text-[14px] text-on-primary-container/60">{WHY_BEST.cta.info}</p>
        </div>
      </div>
    </section>
  );
